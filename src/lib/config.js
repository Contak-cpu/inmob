...
export const CONTRACT_TYPES = {
  comercial: {
    ...
    description: 'Alquiler comercial. El ajuste se define al crear el contrato.',
    icon: 'Store',
    adjustmentType: 'Seleccionable',
    category: 'comercial',
    color: 'primary',
  },
  casa: {
    name: 'Contrato Casa',
    description: 'Vivienda familiar. El ajuste se define al crear el contrato.',
    icon: 'Home',
    adjustmentType: 'Seleccionable',
    category: 'vivienda',
    color: 'secondary',
  ...
  empresas: {
    ...
    description: 'Vivienda o local alquilado por empresas. El ajuste se define al crear el contrato.',
    icon: 'Building',
    adjustmentType: 'Seleccionable',
